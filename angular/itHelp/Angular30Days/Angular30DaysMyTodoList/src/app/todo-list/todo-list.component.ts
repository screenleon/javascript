...
export class TodoListComponent implements OnInit {
   ...
   * @memberof TodoListComponent
   */
  private status: TodoStatusType = TodoStatusType.All;
   ...
   * 設定狀態
   *
   * @param {TodoStatusType} status - 欲設定的狀態
   * @memberof TodoListComponent
   */
   ...
   * 檢查目前狀態
   *
   * @param {TodoStatusType} status - 欲檢查的狀態
   * @returns {boolean}
   * @memberof TodoListComponent
   */
  checkStatus(status: TodoStatusType): boolean {
