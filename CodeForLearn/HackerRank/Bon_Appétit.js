...
function bonAppetit(bill, k, b) {
    const billAddUp = bill.reduce((previous, current) => {
        return previous + current;
    }, 0);
    const appetit = (billAddUp - bill[k]) / 2;
    console.log(b - appetit > 0 ? b - appetit : 'Bon Appetit');
    // return b - appetit > 0 ? b - appetit : 'Bon Appetit';
}
